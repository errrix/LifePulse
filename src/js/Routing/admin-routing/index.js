...
class AdminRouting extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.location.pathname !== "/admin") {
            this.setState({initial_load: this.props.location.pathname})
        }
    }
        ...
        return (
            <Fragment>
                {this.props.update_user ? (
                    <Fragment>
                        {
                            this.props.roles.length !== 0 && (this.props.roles.indexOf('admin') !== -1 || this.props.roles.indexOf('moderator') !== -1)
                                ? (
                                    <Fragment>
                                        <AdminHeader LogoutState={this.LogoutState}/>
                                        <Switch>
                                            ...
                                            <Route path="/admin"
                                                   render={() => <Redirect to={this.state.initial_load}/>}/>
                                        </Switch>
                                    </Fragment>
                                )
                                : (
                                    this.props.roles.length === 0 ? (
                                        <Fragment>
                                            ...
                                            <Switch>
                                                ...
                                                <Route path="/admin/:value" render={() => <Redirect to="/admin"/>}/>
                                            </Switch>
                                        </Fragment>
