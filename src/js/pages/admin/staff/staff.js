...
import editStaffPopup from './staff-popup/edit-staff'
                    ...
                    <div className="account-admin-block-wrapper">
                        ...
                        <div className="account-admin-content-block account-admin-staff">
                            <CSSTransitionGroup transitionName="logn-popup"
                                ...
                                {this.state.showEditPopup ? <editStaffPopup id={this.state.editId} title={this.state.editTitle} updateStatusPopup={this.handleClosePopup}/> : false}
