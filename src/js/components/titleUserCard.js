...
class titleUserCard extends React.Component {
                ...
                <div className="user-card-block">
                    <div className="container">
                        <div className="titleCard">
                            <h1 className="titleCard-fullName">
                                эрика волошинец
                            </h1>
                            <p className="titleCard-shortDiagnosis">
                                Острое нарушение мозгового кровообращения по ишемическому типу в басейне левой
                                внутренней сонной
                                артерии
                            </p>
                        </div>
                        <div className="allInfoBlock">
                            ...
                            <div className="shortInfoBlock">
                                <p className="shortInfoBlock-age">Возраст: <span>38 лет</span></p>
                                <p className="shortInfoBlock-gender">Пол: <span>женский</span></p>
                                <p className="shortInfoBlock-locations">Место
                                    проживания: <span>Торецк, Донецкая область</span>
                                </p>
                                <p className="shortInfoBlock-category">Категория: <span>Онкология</span></p>
                                <p className="shortInfoBlock-startFund">Начало сборов: 24.05.2018</p>
                                <p className="shortInfoBlock-endFund">Окончание сборов: 25.06.2018</p>
